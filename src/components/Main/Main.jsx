...
export const Main = () => {
    return (
        <>
            ...
            <GuaranteeBox />
            <TeamMembers>
                <TeamMember avatar="src/assets/Images/John-Harbinger.jfif" name="John Harbinger" content="Jeg er den mest successfulde advokat i firmaet. I hvert fald mere end Peter." />
                <TeamMember avatar="src/assets/Images/Peter-Parker.jfif" name="Peter Parker" content="Jeg holder af kaffe og så er jeg helt enormt succesfuld. Meget mere end John" />
                <TeamMember avatar="src/assets/Images/Elise-Li.jfif" name="Elise Li" content="Uden ret og lov, kunne vi ligeså godt bo i en skov. Sådan har jeg altid sagt. " />
                <TeamMember avatar="src/assets/Images/Morten-Nate.jfif" name="Morten Nate" content="Jeg er født på landet. På landet er der ingen ret og lov. Det er det vilde vest derude." />
            </TeamMembers>
            <LocationBox />
        </>
    )
